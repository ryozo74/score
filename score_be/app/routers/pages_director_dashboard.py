...
@router.get("/director_dashboard")
def get_director_dashboard(request: Request, actor_id: str = Depends(get_actor_id)):
    ...
    return _templates.TemplateResponse(
        request=request, name="director_dashboard.html",
        context={"role": role, "active": "director_dashboard", "demo_mode": os.getenv("CALENDAR_MOCK", "0") == "1", "user": user, "shots": shots},
    )
